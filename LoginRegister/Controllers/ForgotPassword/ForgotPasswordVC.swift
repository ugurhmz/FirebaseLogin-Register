...
class ForgotPasswordVC: UIViewController {
    ...
    @objc func clickResetBtn(){
        ...
        Auth.auth().sendPasswordReset(withEmail: email) { error in
            ...
            self.createAlert(title: "Password",
                             msg: "Password reset link has been sent to your email address.", prefStyle:
                                     .alert,
                             bgColor: #colorLiteral(red: 0.3411764801, green: 0.6235294342, blue: 0.1686274558, alpha: 1), textColor: .white, fontSize: 24)
